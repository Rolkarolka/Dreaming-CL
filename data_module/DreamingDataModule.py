...
class CIFARDataModule(pl.LightningDataModule):
    def __init__(self, teacher, classes_to_learn, classes_to_dream, logger, data_dir: str = "./data",
        ...
        # datasets
        class_num_samples = {class_name: 64 for class_name in
                             self.classes_to_dream}  # TODO 64 from config and depends on previous datasets
        self.deep_inversion = DeepInversion(class_num_samples, logger=self.logger)
